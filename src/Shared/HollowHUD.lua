...
function HollowHUD.Create()
	...
	-- ===== COIN DISPLAY (below mana bar) =====
	local coinFrame = Instance.new("Frame")
	coinFrame.Name = "CoinDisplay"
	coinFrame.Size = UDim2.new(0, 140, 0, 22)
	coinFrame.Position = UDim2.new(0, 20, 1, -18)
	coinFrame.BackgroundColor3 = Color3.fromRGB(30, 25, 15)
	...
	coinText.Name = "Text"
	coinText.Size = UDim2.new(1, -8, 1, 0)
